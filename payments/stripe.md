...
{% hint style="info" %}
В инструкции прописан способ подключения в **тестовом режиме**. Чтобы отключить текстовый режим, нажмите на переключатель **«Test mode»** в верхнем правом углу и **скопируйте ключи** еще раз.
{% endhint %}
